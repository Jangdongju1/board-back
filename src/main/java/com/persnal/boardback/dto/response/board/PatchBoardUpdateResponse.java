...
@Getter
public class PatchBoardUpdateResponse extends ResponseDto {
    private PatchBoardUpdateResponse(){
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
    }

    public static ResponseEntity<PatchBoardUpdateResponse> success(){
        PatchBoardUpdateResponse response = new PatchBoardUpdateResponse();
