...
| GET | /api/v1/board/comment-list |  |{<br/> "code":"SU",<br/> "message":"example",<br/> "commentList":[{<br/>"nickname":"example",<br/> "profileImg":"url",<br/> "writeDate":"2024-06-27 23:02:53",<br/> "content":"example"<br/>}] <br/>}|
