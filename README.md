...
| GET | /api/v1/board/{boardNum}/favoite-list | |{<br/> &ensp;"code":"SU",<br/> &ensp;"message":"success",<br/> &ensp;"favoriteList":[<br/>&emsp;{<br/> &emsp;&ensp;"userEmail":"example@example.com",<br/> &emsp;&ensp;"nickname":"example",<br/> &emsp;&ensp;"profileImg":"url"<br/> &emsp;}<br/>&ensp;] |  
