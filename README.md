...
| GET | /api/v1/user-board-list/{email} | |{<br/> &ensp;"code":"SU",<br/> &ensp;"message":"success",<br/> &ensp;"userBoardList":[<br/>&emsp;{<br/> &emsp;&ensp;"boardNum" : 0,<br/> &emsp;&ensp;"title" :"example",<br/> &emsp;&ensp;"content" : "example",<br/> &emsp;&ensp;"boardImgList" : "exampleUrl",<br/> &emsp;&ensp;"writeDate":"2024-06-27 23:02:53",<br/> &emsp;&ensp;"writerEmail":"example@example.com",<br/> &emsp;&ensp;"writernickname":"example",<br/> &emsp;&ensp;"writerProfileImg":"exampleUrl"<br/>&emsp;}<br/>&ensp;]<br/>} |
